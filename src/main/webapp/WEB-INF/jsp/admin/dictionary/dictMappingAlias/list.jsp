			...
			<tbody>
				<c:forEach items="${list }" var="item" varStatus="i">
					<tr>
						...
						<td>${item[9] }</td>
						<td>
							<a href="javascript:;" title="修改" itemId="${item[5]}" basicItemId="${item[0]}" mappingId=${criteria.mappingId } id="edit">修改</a>
							<a href="admin/dictionary/dictMappingAlias/do_delete/${item[5] }" confirm="确认删除？">删除</a>
						</td>
					</tr>
				</c:forEach>
			</tbody>
